...
export const categories: Category[] = [
  ...
  {
    id: "takara-water",
    name: "タカラ キッチン・水廻りオプション",
    icon: "🍳",
    items: [
      // タカラ キッチン
      { id: "tak-001", name: "キッチンパネル", price: 85714, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-002", name: "フルフラット対面 奥行105cm", price: 164286, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-003", name: "ダイニング側収納 全収納105cm", price: 128571, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-004", name: "ダイニング側収納 コンロ前収納", price: 50000, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-005", name: "フルフラット対面 奥行90cm", price: 154286, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-006", name: "ダイニング側収納 全収納90cm", price: 128571, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-007", name: "レンジフード SVRA ステンレス", price: 100000, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-008", name: "レンジフード SVRA ブラック", price: 111429, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-009", name: "オイルガード クリア", price: 21429, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-010", name: "オイルガード クリアブラック", price: 28571, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-011", name: "オイルガード ハイタイプ", price: 25714, unit: "fixed", categoryId: "takara-water" },
      { id: "tak-012", name: "オイルガード ハイタイプ ブラック", price: 31429, unit: "fixed", categoryId: "takara-water" },
      // 食洗機
      { id: "dis-001", name: "リンナイ フロントオープン シルバー", price: 142857, unit: "fixed", categoryId: "takara-water" },
      { id: "dis-002", name: "リンナイ フロントオープン ブラック", price: 142857, unit: "fixed", categoryId: "takara-water" },
      { id: "dis-003", name: "Panasonic フロントオープン 45cm", price: 314286, unit: "fixed", categoryId: "takara-water" },
      { id: "dis-004", name: "Panasonic フロントオープン 60cm", price: 428571, unit: "fixed", categoryId: "takara-water" },
      { id: "dis-005", name: "BOSCH 45cm", price: 300000, unit: "fixed", categoryId: "takara-water" },
      { id: "dis-006", name: "BOSCH 60cm", price: 400000, unit: "fixed", categoryId: "takara-water" },
      // 水栓
      { id: "fau-001", name: "タッチレス浄水水栓 LC122MC", price: 85714, unit: "fixed", categoryId: "takara-water" },
      { id: "fau-002", name: "タッチレス浄水水栓 ブラック", price: 114286, unit: "fixed", categoryId: "takara-water" },
      { id: "fau-003", name: "ハンドシャワー水栓 エコ", price: 47143, unit: "fixed", categoryId: "takara-water" },
      { id: "fau-004", name: "ハンドシャワー水栓 上位", price: 95714, unit: "fixed", categoryId: "takara-water" },
      { id: "fau-005", name: "タッチレスハンドシャワー", price: 78571, unit: "fixed", categoryId: "takara-water" },
      { id: "fau-006", name: "タッチレスハンドシャワー 上位", price: 128571, unit: "fixed", categoryId: "takara-water" },
      // IH
      { id: "ih-001", name: "Panasonic IH 140,000タイプ", price: 200000, unit: "fixed", categoryId: "takara-water" },
      { id: "ih-002", name: "Panasonic IH 上位 200,000タイプ", price: 285714, unit: "fixed", categoryId: "takara-water" },
      { id: "ih-003", name: "日立IH シルバー", price: 207143, unit: "fixed", categoryId: "takara-water" },
      { id: "ih-004", name: "日立IH ブラック", price: 207143, unit: "fixed", categoryId: "takara-water" },
      // その他
      { id: "oth-001", name: "キッチン側コンセント", price: 35714, unit: "fixed", categoryId: "takara-water" },
      { id: "oth-002", name: "リビング側コンセント", price: 28571, unit: "fixed", categoryId: "takara-water" },
      { id: "oth-003", name: "エンドパネル コンセント開口", price: 14286, unit: "fixed", categoryId: "takara-water" },
      // カップボード
      { id: "cup-001", name: "周辺収納吹戸棚", price: 57143, unit: "fixed", categoryId: "takara-water" },
      { id: "cup-002", name: "カップボードエンドパネル", price: 17143, unit: "fixed", categoryId: "takara-water" },
      { id: "cup-003", name: "メラミンカウンター用エンドパネル", price: 8571, unit: "fixed", categoryId: "takara-water" },
      // バス
      { id: "bat-001", name: "ハンドバー変更", price: 11429, unit: "fixed", categoryId: "takara-water" },
      { id: "bat-002", name: "マグネットショートミラー", price: 17143, unit: "fixed", categoryId: "takara-water" },
    ],
  },
  {
    id: "flooring",
